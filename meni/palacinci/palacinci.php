            ...
            <div class="meni">
                <div class="meni-header">
                    <div class="header pt-4 pb-4 d-flex justify-content-between align-items-center ps-2 pe-2">
                        ...
                        <ul class="navbar-nav flex-row justify-content-center flex-wrap">
                            ...
                            <li class="nav-item pe-2 ps-2">
                                <a class="nav-link active" href="">PALAČINCI</a>
                            </li>
                            <li class="nav-item pe-2 ps-2">
                ...
                <div class="meni-ponuda">
                    ...
                    <div class="ponuda d-flex justify-content-center align-items-center flex-wrap p-2">
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/kinder-bueno.jpeg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">KINDER BUENO</h5>
                                <p></p>
                        ...
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/med i voce.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">SA MEDOM I VOĆEM</h5>
                                <p></p>
                                <h6 class="p-2 m-0">7KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/sumsko voce.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">ŠUMSKO VOĆE</h5>
                                <p></p>
                                <h6 class="p-2 m-0">7KM</h6>
                            </div>
                        </div>
                        ...
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/americki-palacinci.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">AMERIČKI</h5>
                                <p></p>
                                <h6 class="p-2 m-0">7KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/palacinci-nutela.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">NUTELA</h5>
                                <p></p>
                                <h6 class="p-2 m-0">7KM</h6>
                            </div>
                        </div>

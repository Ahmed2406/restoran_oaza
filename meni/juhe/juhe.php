            ...
            <div class="meni">
                <div class="meni-header">
                    <div class="header pt-4 pb-4 d-flex justify-content-between align-items-center ps-2 pe-2">
                        ...
                        <ul class="navbar-nav flex-row justify-content-center flex-wrap">
                            ...
                            <li class="nav-item pe-2 ps-2">
                                <a class="nav-link active" href="">JUHE</a>
                            </li>
                            <li class="nav-item pe-2 ps-2">
                ...
                <div class="meni-ponuda">
                    ...
                    <div class="ponuda d-flex justify-content-center align-items-center flex-wrap p-2">
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/juha-gljive.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JUHA OD GLJIVA</h5>
                                <p>(gljive, začini)</p>
                        ...
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/juha-tikva.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JUHA OD TIKVE</h5>
                                <p>(tikva, začini)</p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/juha-povrce.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JUHA OD POVRĆA</h5>
                                <p>(domaće povrće, začini)</p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/juha-rajcica.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JUHA OD RAJČINE</h5>
                                <p>(rajčica, začini)</p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/juha-brokula.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JUHA OD BROKULE</h5>
                                <p>(brokula, začini)</p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>

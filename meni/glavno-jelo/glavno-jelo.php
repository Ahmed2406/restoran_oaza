            ...
            <div class="meni">
                <div class="meni-header">
                    <div class="header pt-4 pb-4 d-flex justify-content-between align-items-center ps-2 pe-2">
                        ...
                        <ul class="navbar-nav flex-row justify-content-center flex-wrap">
                            ...
                            <li class="nav-item pe-2 ps-2">
                                <a class="nav-link active" href="">GLAVNO JELO</a>
                            </li>
                            <li class="nav-item pe-2 ps-2">
                ...
                <div class="meni-ponuda">
                    ...
                    <div class="ponuda d-flex justify-content-center align-items-center flex-wrap p-2">
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/biftek.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">BIFTEK</h5>
                                <p></p>
                        ...
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/jagnjetina.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">JANJETINA</h5>
                                <p></p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/pileci-file.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">PILEĆI FILETI</h5>
                                <p></p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        ...
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/pljeskavica.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">PLJESKAVICA</h5>
                                <p></p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
                        <div class="box m-2">
                            <div class="slika">
                                <img src="../../slike/cevapi.jpg" alt="">
                            </div>
                            <div class="text">
                                <h5 class="p-1 m-0">ČEVAPI</h5>
                                <p></p>
                                <h6 class="p-2 m-0">0KM</h6>
                            </div>
                        </div>
